...
async function buildFrontend() {
    ...
    if (!await exists(path.join(frontendDir, "node_modules"))) {
        ...
        try {
            ...
            error(`Frontend install failed: ${e.message}`);
        }
    }
...
async function validateAPI() {
    ...
    try {
        ...
        try {
            ...
            throw new Error(`Could not connect to API: ${e.message}`);
        }
        ...
        try {
            ...
            log(`Frontend check warning: ${e.message}`, COLORS.yellow);
        }
        ...
        try {
            ...
            log(`Docs check warning: ${e.message}`, COLORS.yellow);
        }
    }
    catch (e) {
